...
git clone git@github.com:fdiblen/baklava .
...
Don't forget to also make a [release on GitHub](https://github.com/fdiblen/baklava/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.